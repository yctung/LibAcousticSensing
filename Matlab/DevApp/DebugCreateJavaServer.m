% 2017/03/30: a test script based on demoServer sample script
...
set(socketManager,'OpAcceptCallback',@DebugOnAcceptCallback);
set(socketManager,'OpReadCallback',@DebugOnReceiveCallback);
