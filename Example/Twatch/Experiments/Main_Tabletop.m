...
[upChirp, upSignal] = Helper_CreateSignalLcl('up');
[downChirp, downSignal] = Helper_CreateSignalLcl('down');    
...
function [chirpSignal, playSignal] = Helper_CreateSignalLcl (direction)
    %% Create signals
    global PS
