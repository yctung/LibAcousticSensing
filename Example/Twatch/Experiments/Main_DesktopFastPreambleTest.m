...
function as = SetupAudioSource (soundName, signal)
    ...
    PREAMBLE_FREQS = [7000, 5000];
    PREAMBLE_LENS = [5000, 2000];        % [length of real signals, length of single repeatition]
