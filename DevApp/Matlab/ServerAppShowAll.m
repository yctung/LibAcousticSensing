%==========================================================================
% 2017/04/03: modified to show all necessary data 
%==========================================================================
...
ss = SensingServer(SERVER_PORT, @ServerAppShowAllCallback, SensingServer.DEVICE_AUDIO_MODE_PLAY_AND_RECORD, as);
